...
--  constant kIndexWrite      : std_logic_vector(kIndexInst'range):=          "111";
  ...
  constant kIndexInst       : integer:= 0;
  constant kIndexAddr3      : integer:= 1;
  constant kIndexAddr2      : integer:= 2;
  constant kIndexAddr1      : integer:= 3;
  constant kIndexAddr0      : integer:= 4;
  constant kIndexDummy      : integer:= 5;
  constant kIndexRead       : integer:= 6;
  constant kIndexWrite      : integer:= 7;
